...
**Current version:** `v1.4-em-regional-exposure-waemu-sen-graduated` (served product)
...
| v1.4-em-regional-exposure-waemu-sen-graduated | 2026-04-24 | Live data pull via four specialist agents. Primary sources (BCEAO, UMOA-Titres, IMF) were 403-blocked at the sandbox edge, but WebSearch surfaced substantive quoted excerpts including: SEN titres publics stock 4,758 bn XOF (22% bills / 78% bonds) from UMOA-Titres; "Ivorian investors hold ~42% of Senegalese WAEMU debt" (Ecofin citing rating-agency analysis); "two thirds of Mali government securities bid by other WAEMU members" (IMF CR 23/209 DSA, direct quote); Niger "one-third domestic" (IMF CR 25/025); Togo First per-holder breakdown showing 77.2% of Togolese domestic debt held outside Togo; GNB "87% of domestic debt is UMOA-Titres + BCEAO" (IMF CR 25/167). **Senegal graduated to `ready`**: stock ($7.93bn) × share (0.55) = $4.36bn = 13.3pp GDP, layered into estimated_debt_gdp. SEN now served at 176.1% GDP (Maastricht 99.7% + upstream shadow 63.1pp + regional 13.3pp); preflight flags `above_ceiling` pending human review. MLI / NER / TGO have inferred_article_iv cross-border shares but remain skeleton pending AUT stock. |
