    ...
    categories: [
            ...
            datasets: [
                {
                    ...
                    sourceDetail: 'Average Effective Tariff Rate — Policy through July 21, 2026 (Pre-Substitution)',
                    api: '/api/yale-tariff',
                ...
                {
                    id: 'em-vulnerability',
                    label: 'EM External Vulnerability',
                    source: 'World Bank · WDI',
                    sourceDetail: 'Basic Balance vs. Reserves/Short-Term Debt (Bubble size = GDP)',
                    api: '/api/em-vulnerability',
                    exportUrl: '/api/em-vulnerability/export',
                    type: 'em-vulnerability',
                    controls: ['em-universe'],
                    subviews: [],
                    searchTerms: ['EM', 'emerging markets', 'vulnerability', 'external', 'basic balance',
                        'current account', 'FDI', 'reserves', 'short-term debt', 'bubble chart',
                        'AIG', 'Moody\'s', 'country risk', 'sovereign', 'balance of payments'],
                },
                {
                    id: 'em-reserves',
                    label: 'EM Monthly Reserves',
                    source: 'IMF · Central Banks',
                    sourceDetail: 'Monthly international reserves for top EMs — IMF reserves template (central-bank submissions) + direct feeds for Brazil / Mexico / Türkiye. USD billions.',
                    api: '/api/em-reserves',
                    exportUrl: '/api/em-reserves/export',
                    type: 'em-reserves',
                    controls: [],
                    subviews: [],
                    searchTerms: ['EM', 'emerging markets', 'reserves', 'monthly reserves', 'international reserves',
                        'FX reserves', 'central bank', 'central banks', 'IMF', 'Haver', 'Brazil', 'Mexico', 'Turkey',
                        'reserve adequacy', 'external vulnerability', 'BCB', 'Banxico', 'TCMB'],
                },
                {
                    id: 'us-trade-quarterly',
                    label: 'US Trade (Quarterly)',
                    source: 'FRED · BEA NIPA',
                    sourceDetail: 'US Quarterly Imports, Exports & Net Exports (SAAR, Billions USD)',
                    api: '/api/trade/us-quarterly',
                    exportUrl: '/api/trade/us-quarterly/export',
                    type: 'us-trade-quarterly',
                    controls: ['view', 'range'],
                    subviews: [],
                    searchTerms: ['trade', 'quarterly', 'exports', 'imports', 'net exports', 'EXPGS', 'IMPGS', 'NETEXP', 'BEA', 'NIPA', 'FRED', 'US trade', 'balance'],
                },
                {
                    id: 'weo-exports-vol',
                    label: 'Exports Volume Growth (Forecast)',
                    source: 'IMF World Economic Outlook',
                    sourceDetail: 'Volume of Exports of Goods & Services, Annual % Change (Forecast ~5yr)',
                    api: '/api/weo/TX_RPCH',
                    exportUrl: '/api/weo/TX_RPCH/export',
                    type: 'weo',
                    weoIndicator: 'TX_RPCH',
                    weoUnit: '%',
                    weoValueSuffix: '%',
                    weoValueDecimals: 1,
                    ...
                    searchTerms: ['exports', 'export volume', 'trade forecast', 'WEO', 'IMF', 'growth', 'TX_RPCH', 'projection'],
                },
                {
                    id: 'weo-imports-vol',
                    label: 'Imports Volume Growth (Forecast)',
                    source: 'IMF World Economic Outlook',
                    sourceDetail: 'Volume of Imports of Goods & Services, Annual % Change (Forecast ~5yr)',
                    api: '/api/weo/TM_RPCH',
                    exportUrl: '/api/weo/TM_RPCH/export',
                    type: 'weo',
                    weoIndicator: 'TM_RPCH',
                    weoUnit: '%',
                    weoValueSuffix: '%',
                    weoValueDecimals: 1,
                    controls: ['countries', 'range'],
                    ...
                    searchTerms: ['imports', 'import volume', 'trade forecast', 'WEO', 'IMF', 'growth', 'TM_RPCH', 'projection'],
                },
                {
                    id: 'wb-exports-pct',
                    label: 'Exports (% GDP)',
        ...
        },
        {
            ...
            datasets: [
                ...
                {
                    id: 'currency-debt',
                    label: 'External Debt Composition',
                    source: 'World Bank · IDS',
                    sourceDetail: 'Currency mix + debt stocks by maturity (DRS-reporting countries)',
                    ...
                    subviews: [
                        ...
                        { id: 'total',    label: 'Total External' },
                        { id: 'lt',       label: 'Long-Term' },
                        { id: 'st',       label: 'Short-Term' },
                        { id: 'domestic', label: 'Domestic' },
                    ],
                    searchTerms: ['currency', 'debt', 'composition', 'external debt', 'dollar', 'euro', 'yen', 'SDR', 'DRS', 'IDS', 'foreign currency debt', 'currency mismatch', 'original sin', 'dollarization', 'short-term', 'long-term', 'maturity', 'PPG', 'public debt'],
                },
                {
                    id: 'sovereign-debt',
